...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Với - Trường PTDTBT Tiểu học Mậu Long- ĐT: 0962239330</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Với - Trường PTDTBT Tiểu học Mậu Long - ĐT: 0962239330 </div>", unsafe_allow_html=True)
